...
\title{\textbf{Risk Groups Systems for Penile Cancer Management: A Study of \Sexpr{nrow(Data)} Patients with Invasive Squamous Cell Carcinoma}}
...
\hline
\textbf{No. Cases} & 37 & 56 & 100 & \Sexpr{nrow(Data)} \\
\textbf{pT stage} & \ & \ & \ & \ \\
        \hspace{2ex}Tis/T1    & 18 (49\%)   & 30 (54\%)   & 28 (28\%)   & \Sexpr{T1(table(Data$pT), "T1")} \\
        \hspace{2ex}T2        & 16 (43\%)   & 18 (32\%)   & 33 (33\%)   & \Sexpr{T1(table(Data$pT), "T2")} \\
        \hspace{2ex}T3        & 3 (8\%)     & 8 (14\%)    & 39 (39\%)   & \Sexpr{T1(table(Data$pT), "T3")} \\
\textbf{Histologic grade } & \ & \ & \ & \ \\
        \hspace{2ex}Grade 1   & 20 (54\%)   & 10 (18\%)   & 39 (44\%)   & \Sexpr{T1(table(Data$Grade), "Grade 1")} \\
        \hspace{2ex}Grade 2   & 13 (35\%)   & 27 (48\%)   & 35 (40\%)   & \Sexpr{T1(table(Data$Grade), "Grade 2")} \\
        \hspace{2ex}Grade 3   & 4 (11\%)    & 19 (34\%)   & 14 (16\%)   & \Sexpr{T1(table(Data$Grade), "Grade 3")} \\
\hline 
\end{tabular}
\end{table*}
...
\ & \ & \Sexpr{table(Data$cN_Positive)["No"]} & \Sexpr{table(Data$cN_Positive)["Yes"]} & \Sexpr{sum(table(Data$cN_Positive))} \\
\hline
\textbf{Solsona \emph{et al} system} & \ & \ & \ & \ \\
        \hspace{2ex}High risk & 10/12 (\Sexpr{round(100*10/12)}\%)
                & \Sexpr{T2(Solsona_FN_cN0, "High risk", "Positive")}
                & \Sexpr{T2(Solsona_FN_cN123, "High risk", "Positive")}
                & \Sexpr{T2(Solsona_FN_Table, "High risk", "Positive")} \\
        \hspace{2ex}Intermediate risk & 4/12 (\Sexpr{round(100*4/12)}\%)
                & \Sexpr{T2(Solsona_FN_cN0, "Intermediate risk", "Positive")}
                & \Sexpr{T2(Solsona_FN_cN123, "Intermediate risk", "Positive")}
                & \Sexpr{T2(Solsona_FN_Table, "Intermediate risk", "Positive")} \\
        \hspace{2ex}Low risk & 0/13 (\Sexpr{round(100*0/13)}\%)
                & \Sexpr{T2(Solsona_FN_cN0, "Low risk", "Positive")}
                & \Sexpr{T2(Solsona_FN_cN123, "Low risk", "Positive")}
                & \Sexpr{T2(Solsona_FN_Table, "Low risk", "Positive")} \\
\textbf{EAU system} & \ & \ & \ & \ \\
        \hspace{2ex}High risk & 23/74 (\Sexpr{round(100*23/74)}\%)
                & \Sexpr{T2(EAU_FN_cN0, "High risk", "Positive")}
                & \Sexpr{T2(EAU_FN_cN123, "High risk", "Positive")}
                & \Sexpr{T2(EAU_FN_Table, "High risk", "Positive")} \\
        \hspace{2ex}Intermediate risk & 0/9 (\Sexpr{round(100*0/9)}\%)
                & \Sexpr{T2(EAU_FN_cN0, "Intermediate risk", "Positive")}
                & 0/0 % No cN+ patients in the intermediate category
                & \Sexpr{T2(EAU_FN_Table, "Intermediate risk", "Positive")} \\
        \hspace{2ex}Low risk & 0/17 (\Sexpr{round(100*0/17)}\%)
                & \Sexpr{T2(EAU_FN_cN0, "Low risk", "Positive")}
                & \Sexpr{T2(EAU_FN_cN123, "Low risk", "Positive")}
                & \Sexpr{T2(EAU_FN_Table, "Low risk", "Positive")} \\
\textbf{Hungerhuber \emph{et al} system} & \ & \ & \ & \ \\
        \hspace{2ex}High risk & 3/4 (\Sexpr{round(100*3/4)}\%)
                & \Sexpr{T2(Hungerhuber_FN_cN0, "High risk", "Positive")}
                & \Sexpr{T2(Hungerhuber_FN_cN123, "High risk", "Positive")}
                & \Sexpr{T2(Hungerhuber_FN_Table, "High risk", "Positive")} \\
        \hspace{2ex}Intermediate risk & 2/7 (\Sexpr{round(100*2/7)}\%)
                & \Sexpr{T2(Hungerhuber_FN_cN0, "Intermediate risk", "Positive")}
                & \Sexpr{T2(Hungerhuber_FN_cN123, "Intermediate risk", "Positive")}
                & \Sexpr{T2(Hungerhuber_FN_Table, "Intermediate risk", "Positive")} \\
        \hspace{2ex}Low risk & 1/13 (\Sexpr{round(100*1/13)}\%)
                & \Sexpr{T2(Hungerhuber_FN_cN0, "Low risk", "Positive")}
                & \Sexpr{T2(Hungerhuber_FN_cN123, "Low risk", "Positive")}
                & \Sexpr{T2(Hungerhuber_FN_Table, "Low risk", "Positive")} \\
\hline 
\end{tabular}
\end{table*}
...
\subsection*{Final Lymph Nodes Status}
Distribution according to cN stage was as it follows: \Sexpr{cN_Table["cN0"]} patients (\Sexpr{cN_Prop["cN0"]}\%) were cN0, \Sexpr{cN_Table["cN1"]} (\Sexpr{cN_Prop["cN1"]}\%) were cN1, \Sexpr{cN_Table["cN2"]} (\Sexpr{cN_Prop["cN2"]}\%) were cN2, and \Sexpr{cN_Table["cN3"]} (\Sexpr{cN_Prop["cN3"]}\%) were cN3. The final nodal status was positive in \Sexpr{FN_Table["Positive"]} (\Sexpr{FN_Prop["Positive"]}\%) of all cases. Regarding histologic grade, the final nodal status was positive in \Sexpr{T2(Grade_Table, "Grade 1", "Positive")} of grade 1 tumors, \Sexpr{T2(Grade_Table, "Grade 2", "Positive")} of grade 2 tumors, and \Sexpr{T2(Grade_Table, "Grade 3", "Positive")} of grade 3 tumors. The association between histologic grade and final nodal status was statistically significant (Fisher's exact $P=\Sexpr{format(fisher.test(Grade_Table)$p.value, digits = 2)}$).

Regarding pT stage, the final nodal status was positive in \Sexpr{T2(pT_Table, "T1", "Positive")} of pT1 tumors, \Sexpr{T2(pT_Table, "T2", "Positive")} of pT2 tumors, and \Sexpr{T2(pT_Table, "T3", "Positive")} of pT 3 tumors. The association between pT stage and final nodal status was statistically significant (Fisher's exact $P=\Sexpr{format(fisher.test(pT_Table)$p.value, digits = 2)}$). Table \ref{FinalNodal} summarizes the final nodal status by risk group systems and cN status.

\textbf{Solsona \emph{et al} system:} \Sexpr{T1(Solsona_Table, "High risk")} of patients were located in the high risk category, \Sexpr{T1(Solsona_Table, "Intermediate risk")} in the intermediate category, and \Sexpr{T1(Solsona_Table, "Low risk")} in the low risk category. In the original series the distribution by risk groups was 32.5\%, 32.5\%, and 35\%, respectively \cite{Solsona2001}. Overall, the final nodal status was positive in \Sexpr{T2(Solsona_FN_Table, "High risk", "Positive")} patients in the high risk category, \Sexpr{T2(Solsona_FN_Table, "Intermediate risk", "Positive")} patients in the intermediate risk category, and \Sexpr{T2(Solsona_FN_Table, "Low risk", "Positive")} patients in the low risk category. In the high risk and intermediate risk categories metastatic rates were higher in cN+ patients when compared with cN0 patients. No metastasis were found in the low risk categories, in both cN0 and cN+ patients. Compared to the previously reported rates ours were lower in the high and intermediate risk categories. The association between final nodal status and risk groups was statistically significant (Fisher's exact $P=\Sexpr{format(fisher.test(Solsona_FN_Table)$p.value, digits = 2)}$) when both cN0 and cN+ patients were taken into account. This association remained significant for cN+ patients (Fisher's exact $P=\Sexpr{format(fisher.test(Solsona_FN_cN123)$p.value, digits = 2)}$) but not for cN0 patients (Fisher's exact $P=\Sexpr{format(fisher.test(Solsona_FN_cN0)$p.value, digits = 2)}$).

\textbf{EAU system:} \Sexpr{T1(EAU_Table, "High risk")} of patients were located in the high risk category, \Sexpr{T1(EAU_Table, "Intermediate risk")} in the intermediate category, and \Sexpr{T1(EAU_Table, "Low risk")} in the low risk category. The distribution of patients in the series of Hegarty \emph{et al} was 74\%, 9\%, and 17\%, respectively \cite{Hegarty2006}. Overall, the final nodal status was positive in \Sexpr{T2(EAU_FN_Table, "High risk", "Positive")} patients in the high risk category, \Sexpr{T2(EAU_FN_Table, "Intermediate risk", "Positive")} patients in the intermediate risk category, and \Sexpr{T2(EAU_FN_Table, "Low risk", "Positive")} patients in the low risk category. The metastatic rate in the high risk category was higher in cN+ patients when compared with cN0 patients. All the patients in the intermediate category were cN0 and none presented nodal metastasis. No metastasis were found in the low risk categories, in both cN0 and cN+ patients. Our rates were similar to those reported in the series of Hegarty \emph{et al}. The association between final nodal status and risk groups was not statistically significant for both cN0 and cN+ patients (Fisher's exact $P=\Sexpr{format(fisher.test(EAU_FN_Table)$p.value, digits = 2)}$), cN0 patients alone (Fisher's exact $P=\Sexpr{format(fisher.test(EAU_FN_cN0)$p.value, digits = 2)}$), or cN+ patients alone (Fisher's exact $P=\Sexpr{format(fisher.test(EAU_FN_cN123)$p.value, digits = 2)}$).

\textbf{Hungerhuber \emph{et al} system:} \Sexpr{T1(Hungerhuber_Table, "High risk")} of patients were located in the high risk category, \Sexpr{T1(Hungerhuber_Table, "Intermediate risk")} in the intermediate category, and \Sexpr{T1(Hungerhuber_Table, "Low risk")} in the low risk category. In the original series the distribution by risk groups was 17\%, 29\%, and 54\%, respectively \cite{Hungerhuber2006}. Overall, the final nodal status was positive in \Sexpr{T2(Hungerhuber_FN_Table, "High risk", "Positive")} patients in the high risk category, \Sexpr{T2(Hungerhuber_FN_Table, "Intermediate risk", "Positive")} patients in the intermediate risk category, and \Sexpr{T2(Hungerhuber_FN_Table, "Low risk", "Positive")} patients in the low risk category. In the high risk and intermediate risk categories metastatic rates were higher in cN+ patients when compared with cN0 patients. No metastasis were found in the low risk categories, in both cN0 and cN+ patients. Compared to the previously reported rates ours were lower in all the categories, except for cN+ in the intermediate category. The association between final nodal status and risk groups was statistically significant (Fisher's exact $P=\Sexpr{format(fisher.test(Hungerhuber_FN_Table)$p.value, digits = 2)}$) when both cN0 and cN+ patients were taken into account. This association remained significant for cN+ patients (Fisher's exact $P=\Sexpr{format(fisher.test(Hungerhuber_FN_cN123)$p.value, digits = 2)}$) and for cN0 patients (Fisher's exact $P=\Sexpr{format(fisher.test(Hungerhuber_FN_cN0)$p.value, digits = 2)}$).
...
\begin{figure*}
\centering
<<Survival_FN, echo=FALSE>>=
par(mfrow = c(3, 2), mar = c(3, 4, 2, 2), cex = 0.5)
with(Data, survival.plot(Grade, FollowUp, Final_Nodal, title = "Histologic Grade", position = "bottomright"))
with(Data, survival.plot(pT, FollowUp, Final_Nodal, title = "Pathological T Stage"))
with(Data, survival.plot(cN_Positive, FollowUp, Final_Nodal, title = "Clinical N Stage Positivity"))
with(Data, survival.plot(Solsona, FollowUp, Final_Nodal, title = "Solsona et al System", position = "bottomright"))
with(Data, survival.plot(EAU, FollowUp, Final_Nodal, title = "EAU System"))
with(Data, survival.plot(Hungerhuber, FollowUp, Final_Nodal, title = "Hungerhuber et al System"))
@
...
\begin{figure*}
\centering
<<Survival_DOD, echo=FALSE>>=
par(mfrow = c(3, 2), mar = c(3, 4, 2, 2), cex = 0.5)
with(Data, survival.plot(Grade, FollowUp, DOD, title = "Histologic Grade", position = "bottomright", ylim = c(0.5, 1)))
with(Data, survival.plot(pT, FollowUp, DOD, title = "Pathological T Stage", ylim = c(0.5, 1)))
with(Data, survival.plot(cN_Positive, FollowUp, DOD, title = "Clinical N Stage Positivity", ylim = c(0.5, 1)))
with(Data, survival.plot(Solsona, FollowUp, DOD, title = "Solsona et al System", position = "bottomright", ylim = c(0.5, 1)))
with(Data, survival.plot(EAU, FollowUp, DOD, title = "EAU System", ylim = c(0.5, 1)))
with(Data, survival.plot(Hungerhuber, FollowUp, DOD, title = "Hungerhuber et al System", ylim = c(0.5, 1)))
@
        \caption{Survival curves for final nodal status according to clinicopathologic features and risk group systems. Survival curves were significantly different for all variables except for the EAU system. Follow-up in months is depicted in the x-axes, while the y-axes depict survival functions.}
...
\textbf{Outcome: Final Nodal Status} & ~ & ~ & ~ \\
        \hspace{2ex}Solsona et al system 
                & \Sexpr{ROC_FN_Solsona[2]}
                & \Sexpr{ROC_FN_Solsona[1]}, \Sexpr{ROC_FN_Solsona[3]}
                & \Sexpr{MW_FN_Solsona} \\
        \hspace{2ex}EAU system
                & \Sexpr{ROC_FN_EAU[2]}
                & \Sexpr{ROC_FN_EAU[1]}, \Sexpr{ROC_FN_EAU[3]}
                & \Sexpr{MW_FN_EAU} \\
        \hspace{2ex}Hungerhuber et al
                & \Sexpr{ROC_FN_Hungerhuber[2]}
                & \Sexpr{ROC_FN_Hungerhuber[1]}, \Sexpr{ROC_FN_Hungerhuber[3]}
                & \Sexpr{MW_FN_Hungerhuber} \\
\textbf{Outcome: Cancer-related death} & ~ & ~ & ~ \\
        \hspace{2ex}Solsona et al system
                & \Sexpr{ROC_DOD_Solsona[2]}
                & \Sexpr{ROC_DOD_Solsona[1]}, \Sexpr{ROC_DOD_Solsona[3]}
                & \Sexpr{MW_DOD_Solsona} \\
        \hspace{2ex}EAU system
                & \Sexpr{ROC_DOD_EAU[2]}
                & \Sexpr{ROC_DOD_EAU[1]}, \Sexpr{ROC_DOD_EAU[3]}
                & \Sexpr{MW_DOD_EAU} \\
        \hspace{2ex}Hungerhuber et al system
                & \Sexpr{ROC_DOD_Hungerhuber[2]}
                & \Sexpr{ROC_DOD_Hungerhuber[1]}, \Sexpr{ROC_DOD_Hungerhuber[3]}
                & \Sexpr{MW_DOD_Hungerhuber} \\
\hline
\end{tabular}
\end{table*}
...
\begin{figure*}
\centering
<<ROC, echo=FALSE,fig.height=3>>=
par(mfrow = c(1,2), cex = 0.5)
# Final nodal status
FN_ROC_Solsona <- with(Data, plot.roc(Final_Nodal, Solsona,  main = "Final Nodal Status", lty = 4, col = 4, lwd = 0.5))
FN_ROC_EAU <- with(Data, lines.roc(Final_Nodal, EAU, lty = 2, col = 1, lwd = 0.5))
FN_ROC_Hungerhuber <- with(Data, lines.roc(Final_Nodal, Hungerhuber, lty = 6, col = 2, lwd = 0.5))
legend("bottomright", lty = c(4,2,6), col = c(4,1,2), bty = "n",
       legend = c("Solsona et al system", "EAU system", "Hungerhuber et al system"))
# Cancer-related death
FN_ROC_Solsona <- with(Data, plot.roc(DOD, Solsona,  main = "Cancer-Related Death", lty = 4, col = 4, lwd = 0.5))
FN_ROC_EAU <- with(Data, lines.roc(DOD, EAU, lty = 2, col = 1, lwd = 0.5))
FN_ROC_Hungerhuber <- with(Data, lines.roc(DOD, Hungerhuber, lty = 6, col = 2, lwd = 0.5))
legend("bottomright", lty = c(4,2,6), col = c(4,1,2), bty = "n",
       legend = c("Solsona et al system", "EAU system", "Hungerhuber et al system"))
@
